...
/**
 * Utility class with configure and fill functions for service update graph Calc Fragment
 */
object CalcWidgetChartBuilder : KoinComponent {
     ...
     */
    fun createGraph(chart: LineChart, data: List<Currencies>): LineChart {
    ...
    /**
     * Filling widget graph graph with selected currency
